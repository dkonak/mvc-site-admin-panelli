...
namespace OrnekSite.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var p =db.Products.Where(i=>i.IsApproved == true); //onaylı olan ürünlerde arama yapar
        ...
        public ActionResult ProductList(int id) //kategori id sine göre ürün listeler
        {
